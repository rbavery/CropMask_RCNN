...
def detect(model, dataset_dir, subset):
    ...
    # Read dataset
    dataset = aqua_dataset.AquaDataset(4)
    dataset.load_aqua(dataset_dir, subset)
    dataset.prepare()
    # Load over images
    submission = []
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Mask R-CNN for aquaculture counting and segmentation')
